...
/**
 * Created by sho on 2017/11/24.
 */

public class CheckPlanYesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c = db.query(PlanDatabaseHelper.TABLE_NAME,cols,"day <= ? AND flag = 1",params,null,null,"day asc");
        ...
        list.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        //次の画面に渡すデータをセット
                        Intent intent = new Intent(CheckPlanYesActivity.this,EvaluationFlag.class);
